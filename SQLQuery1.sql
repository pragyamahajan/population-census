...
--average growth for country
select avg(growth)*100 from project..data1;

--average growth for state(aggregate func)
...
--top 3 stat showing highest growth ratio
...
select  state,round(avg(literacy),0) average_literacy_ratio from project..data1
